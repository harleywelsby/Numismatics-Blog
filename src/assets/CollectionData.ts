...
import {
  ...
  Language,
  Theme,
} from '../shared/types/CollectionItem.types';
import { LeaderName } from '../shared/types/Leader.types';
...
export const CollectionData: CollectionItem[] = [
  // 1
  {
    ...
    leader: LeaderName.ConstantiusII,
  ...
  // 3
  {
    ...
    leader: LeaderName.ValentinianII,
    authority: Authority.RomanEmpire,
    denomination: Denomination.Nummus,
    mint: {
  ...
  // 4
  {
    ...
    leader: LeaderName.ConstantineITheGreat,
    authority: Authority.RomanEmpire,
    denomination: Denomination.Nummus,
    mint: {
  ...
  // 5
  {
    ...
    leader: LeaderName.AlexanderIIITheGreat,
  ...
  // 6
  {
    ...
    leader: LeaderName.SeptimiusSeverus,
    authority: Authority.RomanEmpire,
    ...
    characters: [CharacterName.Salus],
  },
  // 7
  {
    id: 7,
    ...
    characters: [CharacterName.Apollo],
  },
  // 8
  {
    id: 8,
    ...
    characters: [CharacterName.Jupiter, CharacterName.CaracallaAndGeta],
  },
  // 9
  {
    id: 9,
    ...
    characters: [CharacterName.Libertas],
  },
  // 10
  {
    id: 10,
    ...
    leader: LeaderName.ValentinianI,
    authority: Authority.RomanEmpire,
    denomination: Denomination.Nummus,
    mint: {
    ...
    characters: [CharacterName.Victory],
  },
  // 11
  {
    id: 11,
    ...
    characters: [CharacterName.Providentia],
    moreDetails: {
  ...
  // 13
  {
    ...
    characters: [CharacterName.JuliaDomna, CharacterName.Vesta],
  },
  // 14
  {
    id: 14,
  ...
  // 16
  {
    ...
    characters: [CharacterName.Securitas],
  },
  // 17
  {
    id: 17,
  ...
  // 18
  {
    ...
    characters: [CharacterName.Heracles, CharacterName.Zeus],
  },
  // 19
  {
    id: 19,
    ...
    leader: LeaderName.SeverusAlexander,
    authority: Authority.RomanEmpire,
    denomination: Denomination.Denarius,
    mint: {
      location: MintLocation.Rome,
    ...
    characters: [CharacterName.Fides],
  },
  // 20
  {
    id: 20,
    ...
    characters: [CharacterName.Genius],
  },
  // 21
  {
    id: 21,
    ...
    characters: [CharacterName.Moneta],
  },
  // 22
  {
    id: 22,
  ...
  // 24
  {
    ...
    themes: [Theme.Captives, Theme.TrophyOfArms],
  },
  // 25
  {
    id: 25,
    ...
    leader: LeaderName.MarcusAurelius,
    authority: Authority.RomanEmpire,
    denomination: Denomination.Denarius,
    mint: {
      location: MintLocation.Rome,
    ...
    characters: [CharacterName.Felicitas],
  },
  // 26
  {
    id: 26,
  ...
  // 27
  {
    ...
    leader: LeaderName.AntoninusPius,
    authority: Authority.RomanEmpire,
    denomination: Denomination.Denarius,
    mint: {
      location: MintLocation.Rome,
    ...
    characters: [CharacterName.Fortuna],
  },
  // 28
  {
    id: 28,
    ...
    leader: LeaderName.PinariusNatta,
    ...
    characters: [CharacterName.Roma, CharacterName.Victory],
    themes: [Theme.Biga],
  },
  // 29
  {
    ...
    leader: LeaderName.PhilipTheArab,
    authority: Authority.RomanEmpire,
    denomination: Denomination.Tetradrachm,
    mint: {
  ...
  // 30
  {
    ...
    characters: [CharacterName.Jupiter, CharacterName.Victory],
    themes: [Theme.TrophyOfArms],
  },
  // 31
  {
    id: 31,
    ...
    leader: LeaderName.TituriusSabinus,
    authority: Authority.RomanRepublic,
    denomination: Denomination.Denarius,
    mint: {
      location: MintLocation.Rome,
    ...
    characters: [CharacterName.TitusTatius, CharacterName.Tarpeia],
  },
  // 32
  {
    id: 32,
    ...
    characters: [CharacterName.KhosrauII],
    themes: [Theme.FireAlter],
  },
  // 33
  {
    id: 33,
    ...
    leader: LeaderName.QuintusTitius,
    authority: Authority.RomanRepublic,
    denomination: Denomination.Denarius,
    mint: {
      location: MintLocation.Rome,
    ...
    characters: [CharacterName.Liber, CharacterName.Pegasus],
  },
];
